...
public abstract class ServiceSpecificAdapter implements ManagedService {
    private static final Logger logger = LoggerFactory.getLogger(ServiceSpecificAdapter.class);

    protected final GenericAdapter genericAdapter;

    private final PropertyHandler propertyHandler;

    public ServiceSpecificAdapter(
    		GenericAdapter genericAdapter, 
    		ServiceSpecificPropertySettings propertySettings) throws GenericAdapterException {
    	this.genericAdapter = genericAdapter;
        this.propertyHandler = new PropertyHandler(propertySettings, getClass().getName());
    }
    ...
    private void applyConfigChanges() throws GenericAdapterException {
    	...
    	deregister();
        register(genericAdapter, createSettings());
    }
    ...
    protected abstract void register(GenericAdapter adapter, ServiceAdapterSettings settings) throws GenericAdapterException;
