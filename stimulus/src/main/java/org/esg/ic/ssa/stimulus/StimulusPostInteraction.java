...
public class StimulusPostInteraction extends ServiceInteraction<StimulusServiceAdapter> {

    private final String node;

    public StimulusPostInteraction(
	...
	public void post(ZonedDateTime timestamp, float value) throws GenericAdapterException {
		PercentValue bindingValue = new PercentValue(node, timestamp, value);
