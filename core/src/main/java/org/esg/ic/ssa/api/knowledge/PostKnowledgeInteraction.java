...
public class PostKnowledgeInteraction extends PostReactKnowledgeInteraction {

	public final static KnowledgeInteractionType TYPE = KnowledgeInteractionType.POST;

    public PostKnowledgeInteraction(GraphPattern argumentGraphPattern, GraphPattern resultGraphPattern) {
    	super(TYPE, argumentGraphPattern, resultGraphPattern);
    }

    public PostKnowledgeInteraction(GraphPattern argumentGraphPattern) {
