...
public class AnswerKnowledgeInteraction extends AskAnswerKnowledgeInteraction {

	public final static KnowledgeInteractionType TYPE = KnowledgeInteractionType.ANSWER;

    public AnswerKnowledgeInteraction(GraphPattern graphPattern) {
