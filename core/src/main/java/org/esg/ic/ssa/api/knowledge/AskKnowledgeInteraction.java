...
public class AskKnowledgeInteraction extends AskAnswerKnowledgeInteraction {

	public final static KnowledgeInteractionType TYPE = KnowledgeInteractionType.ASK;

    public AskKnowledgeInteraction(GraphPattern graphPattern) {
